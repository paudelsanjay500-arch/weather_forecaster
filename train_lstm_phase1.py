...
def train_phase1_lstm():
    ...
    nse, csi, far, pod = calculate_hydrological_metrics(y_test_inv, predictions_inv, threshold)
    ...
    results = {
        ...
        "Benchmark_NSE_Target": 0.7,
        "Benchmark_RMSE_Target": 5.0
    }
